...
--
-- Name: properties pk_element_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT pk_element_properties FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties pk_type_properties; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT pk_type_properties FOREIGN KEY (type_id) REFERENCES public.types(type_id);
